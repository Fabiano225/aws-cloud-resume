...
- [ ] **Phase 3: Backend (The Visitor Counter)**
    ...
    - [ ] Set up API Gateway (REST API) to trigger the Lambda.
...
* **HTML5**: Structured content for the resume.
* **CSS3**: Custom styling with a focus on clean, professional UI (AWS-inspired color palette).
